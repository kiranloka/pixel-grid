      ...
      <div className="mx-auto max-w-4xl px-4 md:px-8 text-center">
        ...
        >
          ...
          <div className="mt-4">
            ...
            <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-5 text-white inline-block">
              ...
              <div className="relative flex justify-center space-x-2 items-center z-10 rounded-full bg-zinc-950 py-2 px-6 ring-1 ring-white/10 transition-colors group-hover:bg-zinc-900">
                <span className="text-sm">Book a Call</span>
                <ArrowRight className="h-4 w-4" />
              </div>
              <span className="absolute bottom-0 left-4 h-px w-[calc(100%-2rem)] bg-linear-to-r from-emerald-400/0 via-emerald-400/90 to-emerald-400/0 transition-opacity duration-500 group-hover:opacity-40" />
            </button>
          </div>
        </motion.div>
      </div>
